/* =========================================================================
   ...
   Texte vocalisé en orthographe standard, translittération DIN 31635
   simplifiée, traduction sobre, et découpage mot à mot pour l'étude.
   ========================================================================= */
...
const Versets = {
  ...
  falaq: {
    ...
    versets: [
      ...
      { ar: 'وَمِنْ شَرِّ النَّفَّاثَاتِ فِي الْعُقَدِ', tr: 'wa-min sharri n-naffāthāti fī l-ʿuqad', fr: 'contre le mal de celles qui soufflent sur les nœuds,' },
      { ar: 'وَمِنْ شَرِّ حَاسِدٍ إِذَا حَسَدَ', tr: 'wa-min sharri ḥāsidin idhā ḥasad', fr: 'et contre le mal de l\'envieux quand il envie.' },
    ],
  },
  ...
  nas: {
    ...
    versets: [
      ...
      { ar: 'مِنْ شَرِّ الْوَسْوَاسِ الْخَنَّاسِ', tr: 'min sharri l-waswāsi l-khannās', fr: 'contre le mal du tentateur furtif,' },
      ...
      { ar: 'مِنَ الْجِنَّةِ وَالنَّاسِ', tr: 'mina l-jinnati wa-n-nās', fr: 'qu\'il soit des djinns ou des hommes.' },
    ],
  },
  ...
  asr: {
    ...
    versets: [
      ...
      { ar: 'إِلَّا الَّذِينَ آمَنُوا وَعَمِلُوا الصَّالِحَاتِ وَتَوَاصَوْا بِالْحَقِّ وَتَوَاصَوْا بِالصَّبْرِ', tr: 'illā lladhīna āmanū wa-ʿamilū ṣ-ṣāliḥāti wa-tawāṣaw bi-l-ḥaqqi wa-tawāṣaw bi-ṣ-ṣabr', fr: 'sauf ceux qui croient, accomplissent les bonnes œuvres, s\'enjoignent mutuellement la vérité et s\'enjoignent mutuellement la patience.' },
    ],
  },

  // Sourate 1 — al-Fātiḥa (l'Ouverture)
  fatiha: {
    numero: 1,
    nom: 'al-Fātiḥa',
    nomFr: 'L\'Ouverture',
    versets: [
      ...
      { ar: 'صِرَاطَ الَّذِينَ أَنْعَمْتَ عَلَيْهِمْ غَيْرِ الْمَغْضُوبِ عَلَيْهِمْ وَلَا الضَّالِّينَ', tr: 'ṣirāṭa lladhīna anʿamta ʿalayhim ghayri l-maghḍūbi ʿalayhim wa-lā ḍ-ḍāllīn', fr: 'le chemin de ceux que Tu as comblés de grâces, non de ceux qui ont encouru Ta colère, ni des égarés.' },
    ],
  },
};
