  ...
  10: {
    ...
    exercices: [
      ...
      { type: 'appariement', consigne: 'Révision : reliez ces mots déjà appris à leur sens (vos futurs sujets de phrases).',
        paires: [ { ar: 'النُّور', fr: 'la lumière', cle: 'nur' }, { ar: 'السَّلَام', fr: 'la paix', cle: 'salam' }, { ar: 'الْجَنَّة', fr: 'le jardin', cle: 'janna' }, { ar: 'الْبَاب', fr: 'la porte', cle: 'bab' } ] },
      ...
      { type: 'contexte', consigne: 'Accordez l\'attribut avec ce sujet féminin.',
        sujet: 'الرَّحْمَة (la miséricorde, fém.)', avant: 'الرَّحْمَةُ', apres: '', options: [{ ar: 'قَرِيبَةٌ', fr: 'proche (f.)' }, { ar: 'قَرِيبٌ', fr: 'proche (m.)' }], bonne: 0,
        traduction: 'la miséricorde est proche', cles: ['rahma','qarib'] },
      ...
      { type: 'oral', consigne: 'Lisez cette phrase nominale, un attribut d\'Allah.',
        phraseAr: 'اللَّهُ عَظِيمٌ', translit: 'allāhu ʿaẓīm', cles: ['azim'] },
    ],
  ...
  11: {
    ...
    exercices: [
      ...
      { type: 'appariement', consigne: 'Reliez chaque groupe prépositionnel (sur du vocabulaire connu) à sa traduction.',
        paires: [ { ar: 'فِي الدَّارِ', fr: 'dans la maison', cle: 'dar' }, { ar: 'مِنَ الرَّبِّ', fr: 'de la part du Seigneur', cle: 'rabb' }, { ar: 'فِي يَوْمٍ', fr: 'en un jour', cle: 'yawm' }, { ar: 'لِلسَّلَامِ', fr: 'pour la paix', cle: 'salam' }, { ar: 'فِي النُّورِ', fr: 'dans la lumière', cle: 'nur' } ] },
  ...
  12: {
    ...
    exercices: [
      ...
      { type: 'appariement', consigne: 'Révision du Cycle I : reliez chaque mot à son sens.',
        paires: [ { ar: 'نُور', fr: 'lumière', cle: 'nur' }, { ar: 'رَحْمَة', fr: 'miséricorde', cle: 'rahma' }, { ar: 'صَلَاة', fr: 'prière', cle: 'salat' }, { ar: 'سَلَام', fr: 'paix', cle: 'salam' } ] },
      { type: 'glisser', consigne: 'Reconstituez « le Livre d\'Allah » (kitābu llāh).',
        ordre: ['كِتَابُ', 'اللَّهِ'], traduction: 'le Livre d\'Allah', cles: ['kitab'] },
      ...
      { type: 'dialogue', consigne: 'Compréhension : à quoi demande-t-on d\'être guidé dans la Fātiḥa ?',
        ...
        options: [{ ar: 'الطَّرِيقَ الْقَوِيمَ', fr: 'la voie droite' }, { ar: 'الْبَيْتَ الْكَبِيرَ', fr: 'la grande maison' }], bonne: 0,
