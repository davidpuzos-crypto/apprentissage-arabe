...
const Lecons = {
  ...
  1: {
    ...
    exercices: [
      ...
      { type: 'dictee', consigne: 'Écoutez, puis choisissez le signe que vous entendez.',
        audio: 'تَ', options: [{ ar: 'تَ' }, { ar: 'بَ' }, { ar: 'ثَ' }], bonne: 0 },
      { type: 'dictee', consigne: 'Écoutez, puis choisissez le signe que vous entendez.',
        audio: 'جَ', options: [{ ar: 'جَ' }, { ar: 'حَ' }, { ar: 'خَ' }], bonne: 0 },
      { type: 'dictee', consigne: 'Écoutez bien le souffle de gorge, puis choisissez.',
        audio: 'حَ', options: [{ ar: 'حَ' }, { ar: 'خَ' }, { ar: 'جَ' }], bonne: 0 },
      { type: 'contexte', consigne: 'Pour lire le son « ja », quelle lettre faut-il, avec une fatḥa ?',
        avant: '', apres: '', options: [{ ar: 'جَ', fr: 'ja' }, { ar: 'حَ', fr: 'ḥa' }, { ar: 'خَ', fr: 'kha' }], bonne: 0,
      ...
      { type: 'dictee', consigne: 'Écoutez, puis écrivez au clavier le signe entendu.',
        mode: 'saisie', audio: 'بَ', reponse: 'بَ' },
  ...
  2: {
    ...
    decouverte: [
      ...
      { lignes: [
        { ar: 'دَار', tr: 'dār', fr: 'une demeure, une maison' },
        { ar: 'بَاب', tr: 'bāb', fr: 'une porte' },
        { ar: 'بَحْر', tr: 'baḥr', fr: 'une mer', note: 'le sukūn ferme la première syllabe : baḥ-r' },
    ...
    vocabulaire: [
      ...
      { ar: 'بَحْر', tr: 'baḥr', fr: 'mer', cle: 'bahr' },
      { ar: 'جَسَد', tr: 'jasad', fr: 'corps', cle: 'jasad' },
    ],
    exercices: [
      ...
      { type: 'dictee', consigne: 'Écoutez, puis choisissez la lettre entendue.',
        audio: 'شَ', options: [{ ar: 'شَ' }, { ar: 'سَ' }, { ar: 'زَ' }], bonne: 0 },
      { type: 'contexte', consigne: 'Pour lire « dou », quelle voyelle poser sur le د ?',
        avant: '', apres: '', options: [{ ar: 'دُ', fr: 'dou (ḍamma)' }, { ar: 'دِ', fr: 'di (kasra)' }, { ar: 'دَ', fr: 'da (fatḥa)' }], bonne: 0,
      ...
      { type: 'contexte', consigne: 'Pour fermer la syllabe « bar » (sans voyelle finale), quel signe sur le ر ?',
        avant: 'بَ', apres: '', options: [{ ar: 'رْ', fr: 'r (sukūn)' }, { ar: 'رَ', fr: 'ra' }, { ar: 'رُ', fr: 'rou' }], bonne: 0,
  ...
  3: {
    ...
    vocabulaire: [
      ...
      { ar: 'صَبْر', tr: 'ṣabr', fr: 'patience', cle: 'sabr' },
    ],
    exercices: [
      ...
      { type: 'dictee', consigne: 'Écoutez : entendez-vous une lettre simple ou emphatique ?',
        audio: 'طَ', options: [{ ar: 'طَ' }, { ar: 'تَ' }], bonne: 0 },
      { type: 'dictee', consigne: 'Écoutez le son de gorge, puis choisissez la lettre.',
        audio: 'عَ', options: [{ ar: 'عَ' }, { ar: 'غَ' }, { ar: 'حَ' }], bonne: 0 },
      { type: 'contexte', consigne: 'Pour lire « ḥajj » (avec un j appuyé), faut-il une shadda sur le ج ?',
        avant: 'حَ', apres: '', options: [{ ar: 'جّ', fr: 'jj (shadda)' }, { ar: 'جْ', fr: 'j (sukūn)' }, { ar: 'جَ', fr: 'ja' }], bonne: 0,
  ...
  4: {
    ...
    exercices: [
      ...
      { type: 'dictee', consigne: 'Écoutez : k ordinaire ou q profond ?',
        audio: 'قَ', options: [{ ar: 'قَ' }, { ar: 'كَ' }], bonne: 0 },
      ...
      { type: 'contexte', consigne: 'Pour lire le son long « ū » dans « nūr », quelle lettre support après le ن + ḍamma ?',
        avant: 'نُ', apres: 'ر', options: [{ ar: 'و', fr: 'ū (wāw)' }, { ar: 'ي', fr: 'ī (yāʾ)' }, { ar: 'ا', fr: 'â (alif)' }], bonne: 0,
  ...
  5: {
    ...
    decouverte: [
      ...
      { texte: "Le tanwīn est une voyelle doublée en fin de mot, qui se prononce avec un « n » : ـٌ (oun), ـٍ (in), ـً (an). Il marque souvent l'indéfini, « un / une »." },
      { lignes: [
    ...
    exercices: [
      ...
      { type: 'contexte', consigne: 'Pour écrire « miséricorde » au féminin, quelle lettre finale ?',
        avant: 'رَحْمَ', apres: '', options: [{ ar: 'ة', fr: 'tāʾ marbūṭa (féminin)' }, { ar: 'ت', fr: 'tāʾ ordinaire' }, { ar: 'ه', fr: 'hāʾ' }], bonne: 0,
      ...
      { type: 'contexte', consigne: 'Choisissez le tanwīn qui donne le son « oun » (indéfini, cas sujet).',
        avant: 'سَلَام', apres: '', options: [{ ar: 'ٌ', fr: '-un (oun)' }, { ar: 'ً', fr: '-an' }, { ar: 'ٍ', fr: '-in' }], bonne: 0,
  ...
  6: {
    ...
    vocabulaire: [
      ...
      { ar: 'قُرْآن', tr: 'qurʾān', fr: 'Coran, récitation', cle: 'quran' },
    ],
    exercices: [
      ...
      { type: 'contexte', consigne: 'Pour écrire « îmân » (la foi), quel support de hamza au début, avec une kasra ?',
        avant: '', apres: 'يمَان', options: [{ ar: 'إِ', fr: 'hamza sous l’alif (i)' }, { ar: 'أَ', fr: 'hamza sur l’alif (a)' }, { ar: 'ا', fr: 'alif nu' }], bonne: 0,
  ...
  7: {
    ...
    exercices: [
      ...
      { type: 'contexte', consigne: 'Choisissez la forme déterminée (« le soleil »).',
        avant: '', apres: '', options: [{ ar: 'الشَّمْس', fr: 'le soleil' }, { ar: 'شَمْس', fr: 'un soleil' }], bonne: 0,
        traduction: 'On veut dire « le soleil », avec l\'article.', cles: ['shams2'] },
  ...
  9: {
    ...
    exercices: [
      ...
      { type: 'contexte', consigne: 'Le sujet est un homme. Choisissez la forme accordée.',
  ...
  10: {
    ...
    exercices: [
      ...
      { type: 'texteLibre', consigne: 'Complétez la phrase nominale : « la maison est … ».',
  ...
  11: {
    ...
    exercices: [
      ...
      { type: 'contexte', consigne: 'On montre un objet féminin proche : choisissez le démonstratif.',
      ...
      { type: 'dialogue', consigne: 'Question fermée : choisissez une réponse cohérente.',
        questionAr: 'هَلْ هَٰذَا وَلَدٌ ؟', questionTr: 'hal hādhā walad', contexte: 'On montre un garçon.',
        options: [{ ar: 'نَعَمْ', fr: 'oui' }, { ar: 'أَيْنَ ؟', fr: 'où ?' }], bonne: 0,
        aides: [{ ar: 'هَلْ', fr: 'est-ce que' }, { ar: 'نَعَمْ', fr: 'oui' }], cles: ['hal','naam'] },
    ],
